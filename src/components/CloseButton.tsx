      ...
      >
        ...
        <span
          className={clsx(
            ...
            "absolute left-1/2 top-1/2 aspect-square h-auto w-full -translate-x-1/2 -translate-y-1/2 bg-current opacity-0 transition-opacity duration-200 group-hover/close-button:opacity-10"
          )}
        ></span>
      </button>
    );
